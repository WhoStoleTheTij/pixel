        ...
        <div class="pixel-search-popup-wrapper">
            <form action="{""|fn_url}" name="search_form" method="get">
                ...
                {strip}
                    ...
                    {if $settings.General.search_objects}
                        {include file="buttons/search_magnifier.tpl" but_name="search.results" alt=__("search")}
                    {else}
                        {include file="buttons/search_magnifier.tpl" but_name="products.search" alt=__("search")}
                    {/if}
                {/strip}
