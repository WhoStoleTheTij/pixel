        ...
        foreach ($combinations as $combination) {
            ...
            if (array_search($_data['combination_hash'], $hashes) === false) {
                ...
                $old_data = db_get_row(
                    ...
                    . "WHERE product_id = ?i AND combination_hash = ?s AND temp = 'Y'",
...
/**
 * Updates products count for categories the product is located in.
 *
 * @param int   $product_id   Product ID
 * @param array $product_data Product data
 * @param bool  $rebuild      Whether categories tree must be rebuilt
 */
