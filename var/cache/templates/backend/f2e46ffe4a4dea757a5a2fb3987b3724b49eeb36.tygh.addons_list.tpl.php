<?php /* Smarty version Smarty-3.1.21, created on 2017-11-21 17:00:12
         compiled from "/Users/richardh/Sites/pixel/design/backend/templates/views/addons/components/addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19042505935a14316c264fc4-79216105%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2e46ffe4a4dea757a5a2fb3987b3724b49eeb36' => 
    array (
      0 => '/Users/richardh/Sites/pixel/design/backend/templates/views/addons/components/addons_list.tpl',
      1 => 1510925878,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '19042505935a14316c264fc4-79216105',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a14316c427374_75687990',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a14316c427374_75687990')) {function content_5a14316c427374_75687990($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
...
" class="row-status<?php if (!$_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?> cm-promo-popup<?php }?>"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'UTF-8');?>
</a>
                    <?php } else { ?>
...
installed"<?php }?>><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php }?>
                <?php } else { ?>
                    <span class="row-status block"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'UTF-8');?>
</span>
                <?php }?>
