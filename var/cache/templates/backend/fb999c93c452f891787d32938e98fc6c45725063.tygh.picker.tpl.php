<?php /* Smarty version Smarty-3.1.21, created on 2017-11-22 15:45:59
         compiled from "/Users/richardh/Sites/pixel/design/backend/templates/pickers/products/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5682864545a157187e74f09-16897123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb999c93c452f891787d32938e98fc6c45725063' => 
    array (
      0 => '/Users/richardh/Sites/pixel/design/backend/templates/pickers/products/picker.tpl',
      1 => 1510925878,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '5682864545a157187e74f09-16897123',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a157188188ee4_07977790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a157188188ee4_07977790')) {function content_5a157188188ee4_07977790($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/Users/richardh/Sites/pixel/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
?><?php
fn_preload_lang_vars(array('add_products','position_short','name','deleted_product','no_items','editing_defined_products','defined_items','name','quantity','options','any_option_combinations','deleted_product','no_items','add_products','add_products'));
?>
...
"><i class="icon-plus"></i> <?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("add_products") : $tmp), ENT_QUOTES, 'UTF-8');?>
</a>
    <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if ($_smarty_tpl->tpl_vars['picker_view']->value) {?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"inner_".((string)$_smarty_tpl->tpl_vars['data_id']->value),'link_text'=>count($_smarty_tpl->tpl_vars['item_ids']->value),'act'=>"link",'content'=>Smarty::$_smarty_vars['capture']['products_list'],'text'=>$_smarty_tpl->__("editing_defined_products"),'picker_meta'=>"cm-bg-close",'method'=>"GET",'no_icon_link'=>true), 0);
