<?php /* Smarty version Smarty-3.1.21, created on 2017-11-21 14:15:41
         compiled from "/Users/richardh/Sites/pixel/design/backend/templates/views/index/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20444484305a140add4eb0d5-31262914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1f7313a4a13e7116559dec9db9f0c53616b710b' => 
    array (
      0 => '/Users/richardh/Sites/pixel/design/backend/templates/views/index/index.tpl',
      1 => 1510925878,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20444484305a140add4eb0d5-31262914',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_5a140add869c46_39052454',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a140add869c46_39052454')) {function content_5a140add869c46_39052454($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_inline_script')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/block.inline_script.php';
if (!is_callable('smarty_block_hook')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_enum')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/modifier.enum.php';
?><?php
fn_preload_lang_vars(array('previous_period','current_period','orders','vendor_payouts.current_balance_text','vendor_payouts.income','sales','taxes','users_carts','order','by','no_data','recent_orders','statistics','active_products','out_of_stock_products','registered_customers','categories','vendors','web_pages','order_by_status','status','qty','shipping','top_sellers','company','total','commission','recent_activity','order','dashboard','installer_complete_title','welcome_screen.administrator_info','admin_panel','welcome_screen.go_admin_panel','welcome_screen.go_settings_wizard','settings_wizard','welcome_screen.run_settings_wizard','storefront','welcome_screen.go_storefront','welcome_screen.learn_more_configuration','welcome_screen.knowledge_base','welcome_screen.thanks'));
?>
...
%
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/modifier.date_format.php';
...
?>
                                    <tr>
                                        <td width="34%">
                                            <a href="<?php echo htmlspecialchars(fn_url("orders.manage?is_search=Y&period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['seller']->value['company_id'])), ENT_QUOTES, 'UTF-8');?>
"
                                            ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['seller']->value['company'], ENT_QUOTES, 'UTF-8');?>
</a>
                                        </td>
...
"><?php echo $_smarty_tpl->__('show_all');?>
                ...
                <?php if (!is_callable('smarty_block_hook')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php }?><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['user'], ENT_QUOTES, 'UTF-8');
...
"><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['product'], ENT_QUOTES, 'UTF-8');?>
</bdi></a><br>
...
"><bdi><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['content']['category'], ENT_QUOTES, 'UTF-8');?>
</bdi></a><br>
                                <?php }?>
