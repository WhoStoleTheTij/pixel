<?php /* Smarty version Smarty-3.1.21, created on 2017-11-22 15:46:37
         compiled from "/Users/richardh/Sites/pixel/design/themes/responsive/templates/views/products/components/product_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17255723535a1571ad323800-61999778%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68034c3a3d0f3122e84675f9f8889214b16011d0' => 
    array (
      0 => '/Users/richardh/Sites/pixel/design/themes/responsive/templates/views/products/components/product_options.tpl',
      1 => 1511262094,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17255723535a1571ad323800-61999778',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a1571ada54d45_08670368',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a1571ada54d45_08670368')) {function content_5a1571ada54d45_08670368($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_replace')) include '/Users/richardh/Sites/pixel/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
if (($_smarty_tpl->tpl_vars['settings']->value['General']['display_options_modifiers']=="Y"&&($_smarty_tpl->tpl_vars['auth']->value['user_id']||($_smarty_tpl->tpl_vars['settings']->value['General']['allow_anonymous_shopping']!="hide_price_and_add_to_cart"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id'])))) {?>
...
?>
        ...
        <div class="ty-control-group ty-product-options__item<?php if (!$_smarty_tpl->tpl_vars['capture_options_vs_qty']->value) {?> product-list-field<?php }?> clearfix" id="opt_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
">
            <?php if (!($_smarty_tpl->tpl_vars['po']->value['option_type']&&strpos("SRC",$_smarty_tpl->tpl_vars['po']->value['option_type'])!==false&&!$_smarty_tpl->tpl_vars['po']->value['variants']&&$_smarty_tpl->tpl_vars['po']->value['missing_variants_handling']=="H")) {?>
                <label id="option_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['po']->value['option_type']!=="F") {?>for="option_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> class="ty-control-group__label ty-product-options__item-label<?php if ($_smarty_tpl->tpl_vars['po']->value['required']=="Y") {?> cm-required<?php }
if ($_smarty_tpl->tpl_vars['po']->value['regexp']) {?> cm-regexp<?php }?>" <?php if ($_smarty_tpl->tpl_vars['po']->value['regexp']) {?>data-ca-regexp="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['regexp'], ENT_QUOTES, 'UTF-8');?>
...
');<?php }?>" <?php if ($_smarty_tpl->tpl_vars['product']->value['exclude_from_calculate']&&!$_smarty_tpl->tpl_vars['product']->value['aoc']||$_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value) {?>disabled="disabled" class="disabled"<?php }?>>
                            <?php if ($_smarty_tpl->tpl_vars['product']->value['options_type']=="S") {?>
                                <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['checkout']||$_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value||($_smarty_tpl->tpl_vars['runtime']->value['checkout']&&!$_smarty_tpl->tpl_vars['po']->value['value'])) {?>
                                    <option value=""><?php if ($_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value) {
...
$_smarty_tpl->tpl_vars["selected_variant"] = new Smarty_variable($_smarty_tpl->tpl_vars['vr']->value['variant_id'], null, 0);?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['variant_name'], ENT_QUOTES, 'UTF-8');?>
...
if (floatval($_smarty_tpl->tpl_vars['vr']->value['modifier'])) {?>(<?php echo smarty_modifier_replace(preg_replace('!<[^>]*?>!', ' ', Smarty::$_smarty_vars['capture']['modifier']),' ','');?>
)<?php }
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
" <?php if (($_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value)&&($_smarty_tpl->tpl_vars['po']->value['not_required']||$_smarty_tpl->tpl_vars['po']->value['required']!="Y")) {?>disabled="disabled"<?php }?>  />
...
$_smarty_tpl->tpl_vars["vr"]->_loop = true;
?>
                                <li><label id="option_description_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['variant_id'], ENT_QUOTES, 'UTF-8');?>
" class="ty-product-options__box option-items"><input type="radio" class="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
][product_options][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['vr']->value['variant_id'], ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['po']->value['value']==$_smarty_tpl->tpl_vars['vr']->value['variant_id']) {
$_smarty_tpl->tpl_vars["selected_variant"] = new Smarty_variable($_smarty_tpl->tpl_vars['vr']->value['variant_id'], null, 0);?>checked="checked"<?php }?> onclick="<?php if ($_smarty_tpl->tpl_vars['product']->value['options_update']) {?>fn_change_options('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
', '<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
');<?php } else { ?> fn_change_variant_image('<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:options_modifiers"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);
                    ...
                    <?php if (!$_smarty_tpl->tpl_vars['po']->value['value']&&$_smarty_tpl->tpl_vars['product']->value['options_type']=="S"&&!($_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value)) {?><p class="ty-product-options__description ty-clear-both"><?php echo $_smarty_tpl->__("please_select_one");?>
</p><?php } elseif (!$_smarty_tpl->tpl_vars['po']->value['value']&&$_smarty_tpl->tpl_vars['product']->value['options_type']=="S"&&($_smarty_tpl->tpl_vars['po']->value['disabled']||$_smarty_tpl->tpl_vars['disabled']->value)) {?><p class="ty-product-options__description ty-clear-both"><?php echo $_smarty_tpl->__("select_option_above");?>
</p><?php }?>
                <?php } else { ?>
                    <input type="hidden" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
...
" <?php if ($_smarty_tpl->tpl_vars['product']->value['exclude_from_calculate']&&!$_smarty_tpl->tpl_vars['product']->value['aoc']) {?>disabled="disabled"<?php }?> class="ty-valign ty-input-text<?php if ($_smarty_tpl->tpl_vars['po']->value['inner_hint']) {?> cm-hint<?php }
if ($_smarty_tpl->tpl_vars['product']->value['exclude_from_calculate']&&!$_smarty_tpl->tpl_vars['product']->value['aoc']) {?> disabled<?php }?>" <?php if ($_smarty_tpl->tpl_vars['po']->value['inner_hint']) {?>title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['inner_hint'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> />
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
" class="ty-product-options__textarea<?php if ($_smarty_tpl->tpl_vars['po']->value['inner_hint']) {?> cm-hint<?php }
if ($_smarty_tpl->tpl_vars['product']->value['exclude_from_calculate']&&!$_smarty_tpl->tpl_vars['product']->value['aoc']) {?> disabled<?php }?>" rows="3" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
][product_options][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['po']->value['option_id'], ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->tpl_vars["_class"] = new Smarty_variable("product-variant-image-selected", null, 0);
} else {
$_smarty_tpl->tpl_vars["_class"] = new Smarty_variable("product-variant-image-unselected", null, 0);
}?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php if (trim(Smarty::$_smarty_vars['capture']['variant_images'])) {?><div class="ty-product-variant-image ty-clear-both"><?php echo Smarty::$_smarty_vars['capture']['variant_images'];?>
</div><?php }?>
        </div>
        <?php } ?>
    </div>
