<?php /* Smarty version Smarty-3.1.21, created on 2017-11-23 20:13:00
         compiled from "/Users/richardh/Sites/pixel/design/themes/pixel_theme/templates/common/product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9610016385a16c69010a7a8-87350889%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3427755bc28554d6c6b0b186987027a84fcd918' => 
    array (
      0 => '/Users/richardh/Sites/pixel/design/themes/pixel_theme/templates/common/product_data.tpl',
      1 => 1511457166,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9610016385a16c69010a7a8-87350889',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_5a16c690f3ebd7_59924985',
  'variables' => 
  array (
    'runtime' => 0,
    'product' => 0,
...
<?php if ($_valid && !is_callable('content_5a16c690f3ebd7_59924985')) {function content_5a16c690f3ebd7_59924985($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/modifier.enum.php';
if (!is_callable('smarty_block_hook')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_live_edit')) include '/Users/richardh/Sites/pixel/app/functions/smarty_plugins/function.live_edit.php';
...
?><?php
fn_preload_lang_vars(array('text_combination_out_of_stock','text_out_of_stock','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','old_price','list_price','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','quantity','text_cart_min_qty','text_edp_product','text_combination_out_of_stock','text_out_of_stock','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','old_price','list_price','enter_your_price','contact_us_for_price','sign_in_to_view_price','inc_tax','including_tax','you_save','you_save','save_discount','quantity','text_cart_min_qty','text_edp_product'));
?>
...
" />
<div class="pixel-new-products-wishlist">
    <img src="design/themes/pixel_theme/media/images/Pixel/unselected_wishlist.png"/>
</div>
<?php }?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
--></span>
    <div class="pixel-rating-stars">
        <img src="design/themes/pixel_theme/media/images/Pixel/product_rating.jpg"/>
    </div>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
